...
public abstract class UUIDUtil {
     ...
     * @return
     */
    public static String base64UUIDEncode(String uuid) {
        return base64UUID(UUID.fromString(uuid));
    }
     ...
     * @return
     */
    public static String base64UUIDDecode(String uuid) {
        byte[] byUuid = Base64.decodeBase64(uuid);
     ...
     * @return
     */
    public static String base58UUIDEncode(String uuid) {
        return base58UUID(UUID.fromString(uuid));
    }
     ...
     * @return
     */
    public static String base58UUIDDecode(String uuid) {
        byte[] byUuid = Base58.decode(uuid);
        ByteBuffer bb = ByteBuffer.wrap(byUuid);
        return new UUID(bb.getLong(), bb.getLong()).toString();
    }
