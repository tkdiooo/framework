...
import com.qi.common.cache.ehcache.inf.Cache;
import com.qi.common.cache.ehcache.inf.Cacheable;
...
public class DefaultCache<K, V> implements Cache<K, V> {
  ...
  private static final Logger Log = new Logger(DefaultCache.class);
   ...
   public Set<Map.Entry<K, V>> entrySet() {
       ...
       synchronized (this) {
           ...
           for (final Map.Entry<K, CacheObject<V>> entry : map.entrySet()) {
