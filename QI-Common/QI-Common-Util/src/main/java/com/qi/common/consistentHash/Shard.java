 ...
 * @version Description:
 */
public class Shard<T extends Node> {
...
//      System.out.println(Long.MAX_VALUE);
        Node s1 = new Node("s1", "192.168.1.1", "3306");
        Node s2 = new Node("s2", "192.168.1.2", "3306");
        Node s3 = new Node("s3", "192.168.1.3", "3306");
        Node s4 = new Node("s4", "192.168.1.4", "3306");
        Node s5 = new Node("s5", "192.168.1.5", "3306");
        shards.add(s1);
        shards.add(s2);
        shards.add(s3);
        shards.add(s4);
