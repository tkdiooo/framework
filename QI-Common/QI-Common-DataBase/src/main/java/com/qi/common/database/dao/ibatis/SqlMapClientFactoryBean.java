...
public class SqlMapClientFactoryBean implements FactoryBean<SqlMapClient>, InitializingBean {
     ...
     *
     * @see #setLobHandler
     * @see com.qi.common.database.dao.ibatis.support.ClobStringTypeHandler
     * @see com.qi.common.database.dao.ibatis.support.BlobByteArrayTypeHandler
     * @see com.qi.common.database.dao.ibatis.support.BlobSerializableTypeHandler
     */
